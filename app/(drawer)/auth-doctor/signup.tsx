...
const Signup = () => {
  ...
  const onSubmit: SubmitHandler<FormData> = async (data) => {
    ...
    try {
      const response = await signupCall(data.fullName, data.email, data.password);
  ...
  return (
    <SafeAreaView className='px-5'>
      <View className='h-full justify-center'>
        ...
        <Link href='/auth-doctor/login' className='mt-4 text-primary text-center text-lg font-semibold'>
